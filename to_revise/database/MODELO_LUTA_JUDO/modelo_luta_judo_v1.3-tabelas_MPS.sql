...
ALTER TABLE CONVERSAO ADD CONSTRAINT PK_CONVERSAO PRIMARY KEY (cd_conversao);
...
CREATE TABLE MPS_ITEM_TIPO (
 id INT NOT NULL,
 nome VARCHAR(100)
);

ALTER TABLE MPS_ITEM_TIPO ADD CONSTRAINT PK_MPS_ITEM_TIPO PRIMARY KEY (id);
...
ALTER TABLE MPS_ITEM ADD CONSTRAINT PK_MPS_ITEM PRIMARY KEY (id);


ALTER TABLE CONVERSAO_ACAO ADD CONSTRAINT FK_CONVERSAO_ACAO_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);


ALTER TABLE CONVERSAO_ACAO_TIPO ADD CONSTRAINT FK_CONVERSAO_ACAO_TIPO_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);


ALTER TABLE CONVERSAO_LUTA_ACAO ADD CONSTRAINT FK_CONVERSAO_LUTA_ACAO_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);


ALTER TABLE CONVERSAO_TECNICA ADD CONSTRAINT FK_CONVERSAO_TECNICA_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);


ALTER TABLE CONVERSAO_TECNICA_DIRECAO ADD CONSTRAINT FK_CONVERSAO_TECNICA_DIRECAO_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);


ALTER TABLE CONVERSAO_TECNICA_PONTUACAO ADD CONSTRAINT FK_CONVERSAO_TECNICA_PONTUACAO_0 FOREIGN KEY (cd_conversao) REFERENCES CONVERSAO (cd_conversao);
...
ALTER TABLE MPS_ITEM ADD CONSTRAINT FK_MPS_ITEM_0 FOREIGN KEY (id_tipo) REFERENCES MPS_ITEM_TIPO (id);
ALTER TABLE MPS_ITEM ADD CONSTRAINT FK_MPS_ITEM_1 FOREIGN KEY (id_acao) REFERENCES ACAO (id);
ALTER TABLE MPS_ITEM ADD CONSTRAINT FK_MPS_ITEM_2 FOREIGN KEY (id_tecnica) REFERENCES TECNICA (id);
ALTER TABLE MPS_ITEM ADD CONSTRAINT FK_MPS_ITEM_3 FOREIGN KEY (id_direcao) REFERENCES TECNICA_DIRECAO (id);
ALTER TABLE MPS_ITEM ADD CONSTRAINT FK_MPS_ITEM_4 FOREIGN KEY (id_pontuacao) REFERENCES TECNICA_PONTUACAO (id);
